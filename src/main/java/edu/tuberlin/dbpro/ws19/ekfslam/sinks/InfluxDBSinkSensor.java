...
public class InfluxDBSinkSensor<T extends DataPoint<? extends Number>> extends RichSinkFunction<T> {
    ...
    private static String field2Name = "steering";
     ...
     * @param measurement
     */
    public InfluxDBSinkSensor(String dbName, String measurement){
    ...
    public void invoke(DataPoint dataPoint, Context context) throws Exception {
        Tuple3 value =  (Tuple3) dataPoint.getValue();
        Point.Builder builder = Point.measurement(measurement)
                ...
                .addField(field2Name, (Double) value.f2);
