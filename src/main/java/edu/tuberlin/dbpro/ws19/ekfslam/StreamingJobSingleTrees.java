...
import edu.tuberlin.dbpro.ws19.ekfslam.functions.ClassifyTrees;
 ...
 */
public class StreamingJobSingleTrees {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<KeyedDataPoint> fullData = env.readTextFile("src/main/resources/time_xIncr_yIncr_laserArr_full.csv")
                .map(new ParseData())
                .keyBy("key")
                .flatMap(new ClassifyTrees());

        fullData.map(new getTuple4())
                .writeAsCsv("src/main/resources/positionWithTrees.csv", FileSystem.WriteMode.OVERWRITE);
